                            ...
                            child: GestureDetector(
                              onTap: (){
                                if(aboutMeSelected == false) {
                                  Provider.of<ValueProvider>(context, listen: false).changeAboutMeSelectedTabletTo(true);
                                } else {
                                  Provider.of<ValueProvider>(context, listen: false).changeAboutMeSelectedTabletTo(false);
                                }
                              },
                              child: Container(

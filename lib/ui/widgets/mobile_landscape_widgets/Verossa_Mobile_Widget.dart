...
class VerossaMobile extends StatefulWidget {
  @override
  _VerossaMobileState createState() => _VerossaMobileState();
}

class _VerossaMobileState extends State<VerossaMobile> {
                            ...
                            child: GestureDetector(
                              onTap: (){
                                if(verossaSelected == false) {
                                  Provider.of<ValueProvider>(context, listen: false).changeVerossaSelectedMobileTo(true);
                                } else {
                                  Provider.of<ValueProvider>(context, listen: false).changeVerossaSelectedMobileTo(false);
                                }
                              },
                              child: Container(

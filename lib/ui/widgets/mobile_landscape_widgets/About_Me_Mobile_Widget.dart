                            ...
                            child: GestureDetector(
                              onTap: (){
                                if(aboutMeSelected == false) {
                                  Provider.of<ValueProvider>(context, listen: false).changeAboutMeSelectedMobileTo(true);
                                } else {
                                  Provider.of<ValueProvider>(context, listen: false).changeAboutMeSelectedMobileTo(false);
                                }
                              },
                              child: Container(

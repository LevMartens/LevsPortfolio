...
class VocabexMobile extends StatefulWidget {
  @override
  _VocabexMobileState createState() => _VocabexMobileState();
}

class _VocabexMobileState extends State<VocabexMobile> {
                            ...
                            child: GestureDetector(
                              onTap: (){
                                if(vocabexSelected == false) {
                                  Provider.of<ValueProvider>(context, listen: false).changeVocabexSelectedMobileTo(true);
                                } else {
                                  Provider.of<ValueProvider>(context, listen: false).changeVocabexSelectedMobileTo(false);
                                }
                              },
                              child: Container(

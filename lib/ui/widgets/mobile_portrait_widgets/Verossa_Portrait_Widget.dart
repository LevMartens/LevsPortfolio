...
class VerossaPortrait extends StatefulWidget {
  @override
  _VerossaPortraitState createState() => _VerossaPortraitState();
}

class _VerossaPortraitState extends State<VerossaPortrait> {
  ...
  Widget build(BuildContext context) {
    ...
    double verossaACHeight() {
      if(verossaSelected == true && screenWidth < 1025) { return 3413;}
                            ...
                            child: GestureDetector(
                              onTap: (){
                                if(verossaSelected == false) {
                                  Provider.of<ValueProvider>(context, listen: false).changeVerossaSelectedPortraitTo(true);
                                } else {
                                  Provider.of<ValueProvider>(context, listen: false).changeVerossaSelectedPortraitTo(false);
                                }
                              },
                              child: Container(

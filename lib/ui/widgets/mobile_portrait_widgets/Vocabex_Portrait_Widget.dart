...
class VocabexPortrait extends StatefulWidget {
  @override
  _VocabexPortraitState createState() => _VocabexPortraitState();
}

class _VocabexPortraitState extends State<VocabexPortrait> {
  ...
  Widget build(BuildContext context) {
    ...
    double vocabexACHeight() {
      if(vocabexSelected == true && screenWidth < 1025) { return 2273;}
                            ...
                            child: GestureDetector(
                              onTap: (){
                                if(vocabexSelected == false) {
                                  Provider.of<ValueProvider>(context, listen: false).changeVocabexSelectedPortraitTo(true);
                                } else {
                                  Provider.of<ValueProvider>(context, listen: false).changeVocabexSelectedPortraitTo(true);
                                }
                              },
                      ...
                      GestureDetector(
                        onTap: (){
                          if(vocabexSelected == false) {
                            ...
                            Provider.of<ValueProvider>(context, listen: false).changeVocabexSelectedPortraitTo(false);
                          }
                        },
                        child: Padding(
